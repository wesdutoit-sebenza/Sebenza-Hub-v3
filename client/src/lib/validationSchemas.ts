...
export const insertRoleSchema = z.object({
  ...
  locationCountry: z.string().default('South Africa').optional(),
  workType: z.string().optional(),
  mustHaveSkills: z.array(z.string()).default([]),
  niceToHaveSkills: z.array(z.string()).default([]),
  salaryMin: z.number().optional(),
  salaryMax: z.number().optional(),
  salaryCurrency: z.string().default('ZAR').optional(),
  knockouts: z.array(z.string()).default([]),
  weights: z.object({
    skills: z.number().default(35),
    experience: z.number().default(25),
    achievements: z.number().default(15),
    education: z.number().default(10),
    location_auth: z.number().default(10),
    salary_availability: z.number().default(5),
  }).optional(),
