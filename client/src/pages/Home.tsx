        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="p-6 hover-elevate" data-testid="card-process-post">
            ...
            <div className="flex items-start gap-6">
              <div className="flex h-32 w-32 mt-10 shrink-0 items-center justify-center rounded-full bg-amber/10">
                <Briefcase className="text-amber" size={64} />
              </div>
              <div>
          ...
          <Card className="p-6 hover-elevate" data-testid="card-process-screen">
            ...
            <div className="flex items-start gap-6">
              <div className="flex h-32 w-32 mt-10 shrink-0 items-center justify-center rounded-full bg-amber/10">
                <Brain className="text-amber" size={64} />
              </div>
              <div>
          ...
          <Card className="p-6 hover-elevate" data-testid="card-process-interview">
            ...
            <div className="flex items-start gap-6">
              <div className="flex h-32 w-32 mt-10 shrink-0 items-center justify-center rounded-full bg-amber/10">
                <Video className="text-amber" size={64} />
              </div>
              <div>
          ...
          <Card className="p-6 hover-elevate" data-testid="card-process-hire">
            ...
            <div className="flex items-start gap-6">
              <div className="flex h-32 w-32 mt-10 shrink-0 items-center justify-center rounded-full bg-amber/10">
                <CheckCircle className="text-amber" size={64} />
              </div>
              <div>
